...
# Title & Description
# ===============================
st.title("🏀 AI Basketball Shooting Coach")
st.write(
...
if uploaded_file is not None:
    ...
    # Inference Button
    # ===============================
    if st.button("🧠 Analyze My Shooting Form"):
        ...
        if "error" in result:
            ...
            # Score Section
            # ===============================
            st.subheader("📊 Shooting Form Score")
            ...
            # ===============================
            st.subheader("🦾 Joint Contribution Breakdown (Explainable AI)")
            ...
            if len(feedback) == 0:
                st.write("• No specific feedback available for this shot.")
            else:
                for msg in feedback:
                    st.write("• " + msg)
