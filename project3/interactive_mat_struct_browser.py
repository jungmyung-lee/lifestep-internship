...
This browser:
  • Recursively navigates MATLAB structs
  • Displays nested fields and struct arrays as clickable buttons
  • Shows shapes and previews for large numeric arrays
  • Maintains navigation history for easy backtracking
    ...
    def render(self):
        with self.output:
            ...
            if isinstance(obj, np.void):
                ...
                display(make_button("⬅️ BACK", lambda b: self.go_back()))
